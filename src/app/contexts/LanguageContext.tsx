...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'footer.services.4': 'Intercity transport',
    'footer.services.5': 'Office relocations',
  ...
  ru: {
    ...
    'footer.services.4': 'Междугородние перевозки',
    'footer.services.5': 'Офисные переезды',
  ...
  uk: {
    ...
    'footer.services.4': 'Міжміські перевезення',
    'footer.services.5': 'Офісні переїзди',
  ...
  pl: {
    ...
    'footer.services.4': 'Transport międzymiastowy',
    'footer.services.5': 'Przeprowadzki biurowe',
